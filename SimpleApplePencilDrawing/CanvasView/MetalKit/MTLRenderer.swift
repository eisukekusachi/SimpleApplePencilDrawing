...
public final class MTLRenderer: Sendable, MTLRendering {
    ...
    public func drawGrayPointBuffersWithMaxBlendMode(
        ...
        encoder?.setVertexBuffer(buffers.brightnessBuffer, offset: 0, index: 1)
        encoder?.setVertexBuffer(buffers.diameterBuffer, offset: 0, index: 2)
    ...
    public func drawTexture(
        ...
        guard
            ...
            Logger.error(String(localized: "Unable to load required data"))
            return
        }
    ...
    public func mergeTexture(
        ...
        guard
            ...
            Logger.error(String(localized: "Texture size mismatch"))
            return
        }
